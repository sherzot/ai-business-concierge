...
| R-021 | AI Документовед binary output | Staging verified / production pending; real PDF/DOCX, embedded Noto Sans JP, private Storage, canonical path, restrictive RLS и 60-second signed URL green | Docs |
