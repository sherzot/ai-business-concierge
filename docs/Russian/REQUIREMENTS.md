...
| R-016 | HR Candidate Analysis | Partial; provider-independent и mocked-provider boundaries, typed `AI_UNAVAILABLE`, 30s deadline, quota/accounting и frontend готовы (backend HR 101/101; frontend 12/12). Остаются live smoke, active route и full flow | HR |
