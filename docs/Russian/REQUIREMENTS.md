...
| R-021 | AI Документовед binary output | Staging verified / production pending; real PDF/DOCX, embedded Noto Sans JP, private Storage, immutable UUID-versioned paths, 5m provisional плюс post-signing 65s lease, export/edit/delete row-version CAS, DB-first compensation/delete, restrictive RLS и 60s signed URL green | Docs |
