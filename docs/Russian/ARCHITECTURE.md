...
*HR Candidate — target modular pattern: bounded adapter/request/quota-lifecycle/multipart/orchestrator, strict provider contract и deterministic scoring/report boundaries real; semantic LLM invocation/full HTTP wiring остаётся partial scaffold.*
