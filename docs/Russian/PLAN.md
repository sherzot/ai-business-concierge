...
> Версия 7.1 · Обновлено 2026-08-22
...
- [ ] Map provider/config/accounting failure в typed `AI_UNAVAILABLE` + HTTP `503`; синхронизировать backend schema/orchestrator/application regression и frontend UZ/JA/EN/RU copy, сохраняя route disabled.
