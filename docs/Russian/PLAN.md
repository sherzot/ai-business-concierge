...
- [ ] Push generate/PDF follow-up PR #11: binary-before-DB publication, O(n) glyph wrapping и delete/export CAS; пройти новые GitHub CI, Netlify preview и Codex re-review, затем merge.
