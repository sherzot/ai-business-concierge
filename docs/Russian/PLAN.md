...
> Версия 6.4 · Обновлено 2026-08-22
...
- [ ] **BLOCKED — `ANTHROPIC_API_KEY`:** подключить real CV semantic structuring и Sonnet scoring/report LLM Router calls к готовому strict-output и account-before-validation contract.
