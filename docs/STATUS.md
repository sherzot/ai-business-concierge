...
| Unit test | Frontend 28/28 fayl, 127/127 test, jumladan HR Candidate API/form/hook 12/12; AI polish/router/usage Deno 18/18; HR GitHub 10 + CV 8 + boundary 5 + quota 7 + multipart 6 + accounting 4 + provider contract 8 + scorer 4 + report 6 + orchestrator 6 + schema 1 = 65/65; Telegram bilan joriy targeted backend Deno 69/69; oldingi document binary/lifecycle Deno 7/7 |
...
| Remote GitHub Actions | Final code commit `550ca8b` uchun main run `32552046675` 1m15sda success: Deno 69/69 va backend quality, frontend 28/28 fayl 127/127, deploy-env 14/14, audit 0 high/critical, 3,701-module build va 10-file security green |
