...
| R-016 | HR Candidate Analysis | Partial | Provider-independent va mocked-provider boundarylar, typed `AI_UNAVAILABLE`, 30s deadline, quota/accounting va frontend tayyor (backend HR 101/101; frontend 12/12); live smoke, active route va full-flow qolgan |
