...
| R-016 | HR Candidate Analysis | Partial | GitHub/cache, bounded PDF/DOCX, request/role, PostgreSQL quota, bounded multipart, atomic/idempotent usage-cost persistence, deterministik scorer, 3-tilli evidence report, orchestrator/schema va frontend boundary tayyor (backend HR 56/56; frontend 12/12); semantic Haiku/Sonnet refinement, provider accounting call-site, active route va full-flow qolgan |
