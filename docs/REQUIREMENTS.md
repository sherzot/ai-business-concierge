...
| R-016 | HR Candidate Analysis | Partial | GitHub/cache, bounded PDF/DOCX, request/role, PostgreSQL quota, bounded multipart, atomic/idempotent usage-cost persistence, orchestrator/schema va frontend boundary tayyor (backend HR 47/47; frontend 12/12); Haiku/Sonnet, provider accounting call-site, active route va full-flow qolgan |
