...
| R-016 | HR Candidate Analysis | Partial | Public GitHub analyzer/cache 10/10 va real public smoke bilan tayyor; CV/LLM, auth/rate limit, route wiring va full-flow testlar qolgan |
