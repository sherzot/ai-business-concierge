...
| R-016 | HR Candidate Analysis | Partial; provider-independent and mocked-provider boundaries, typed `AI_UNAVAILABLE`, 30s deadline, quota/accounting, and frontend are ready (backend HR 101/101; frontend 12/12). Live smoke, active route, and full flow remain | HR |
