...
| R-021 | AI Document Maker binary output | Staging verified / production pending; real PDF/DOCX, embedded Noto Sans JP, private Storage, immutable UUID-versioned paths, post-metadata replacement cleanup, DB-first delete, restrictive RLS, and 60-second signed URLs are green | Docs |
