...
| R-016 | HR Candidate Analysis | Partial; public GitHub analyzer/cache passed 10/10 and live public smoke. CV/LLM, auth/rate-limit, route wiring, and full-flow tests remain | HR |
