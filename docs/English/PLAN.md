...
> Version 7.0 · Updated 2026-08-22
...
- [ ] Enforce the documented 30-second global deadline over orchestrator/application execution; cover sequential CV/scoring/report stage budgets and timeout mapping while keeping the route disabled.
