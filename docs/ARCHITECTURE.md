...
*Sana: 2026-05-05*
*HR Candidate target modular pattern: bounded adapter/request/quota-lifecycle/multipart/orchestrator, private in-memory CV seam, minimized prompt/injectable provider-stage/strict output hamda deterministic merge boundary real; key/accounting composition va full HTTP wiring partial scaffold.*
