...
*Sana: 2026-05-05*
*HR Candidate target modular pattern: bounded adapter/request/quota-lifecycle/multipart/orchestrator, minimized prompt/strict provider contract hamda deterministic scoring/report boundary real; semantic LLM invocation/full HTTP wiring partial scaffold.*
