...
- Qolgan ish: draft PR #10ni review/merge qilish; stacked branchni push/PR/CI/Netlify preview/Codex reviewdan o'tkazish; faqat approved merge'dan keyin production migration/Edge rollout va authenticated smoke-test. Undan keyingi mahsulot ishi — LLM Router orqali AI savol-javob/polishing.
