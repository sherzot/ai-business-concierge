...
- [ ] **BLOCKED — `ANTHROPIC_API_KEY`:** Real CV semantic structuringとSonnet scoring/report LLM Router callを準備済みminimized/injection-resistant prompt -> account-before-validation -> strict-output pipelineへ接続しlive-smoke。
