...
- [ ] Server-only key、tenant/request cache scope、atomic accounting closureをprovider stagesへinjectするserver composition-root factoryを追加し、missing configurationとmocked-provider behaviorをtestする。
