...
- [ ] Provider/config/accounting failureをtyped `AI_UNAVAILABLE` + HTTP `503`へmapし、backend schema/orchestrator/application regressionとfrontend UZ/JA/EN/RU copyを同期。Routeはdisabledのまま。
