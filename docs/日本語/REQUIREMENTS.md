...
| R-016 | HR Candidate Analysis | Partial。Public GitHub analyzer/cacheとbounded local PDF/DOCX extractionはready（HR 18/18）。Haiku/Sonnet、auth/rate-limit、route wiring、full-flow testsが残る | HR |
