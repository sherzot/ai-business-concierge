...
| R-021 | AI書類メーカーbinary output | Staging verified / production pending。実PDF/DOCX、embedded Noto Sans JP、private Storage、immutable UUID-versioned path、export CAS、120s retained-version grace、DB-first compensation/delete、restrictive RLS、60s signed URLはgreen | Docs |
