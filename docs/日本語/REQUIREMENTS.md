...
- [x] Integrations – Telegram、メール、AmoCRM基盤。Secure Telegram rollout実行とproduction smokeが残る
...
| R-016 | HR Candidate Analysis | Partial。Provider-independent/mock-provider boundaries、typed `AI_UNAVAILABLE`、30s deadline、quota/accounting、frontendはready（backend HR 101/101、frontend 12/12）。Live smoke、active route、full flowが残る | HR |
