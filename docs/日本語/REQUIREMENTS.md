...
| R-021 | AI書類メーカーbinary output | Staging verified / production pending。実PDF/DOCX、embedded Noto Sans JP、private Storage、immutable UUID-versioned path、post-metadata replacement cleanup、DB-first delete、restrictive RLS、60秒signed URLはgreen | Docs |
