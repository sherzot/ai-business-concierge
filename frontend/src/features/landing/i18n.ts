...
export const landingI18n: Record<LandingLocale, LandingDict> = {
  ...
  uz: {
    ...
    hero: {
      badge: "Beta — hozir bepul foydalaning",
      title: "O'zbekistondagi mahalliy va xalqaro kichik bizneslar uchun AI yordamchisi",
      subtitle:
        "Soliqlar, Mehnat kodeksi, shartnomalar va Telegram orqali savdo — 24/7, 5 soniyada aniq javob. Professional maslahat narxining 10 foiziga.",
      ctaTelegram: "Telegram botni sinab ko'rish",
      ctaLogin: "Dashboardga kirish",
    ...
    stats: {
      items: [
        ...
        { value: "4", label: "Til: o'zbek / rus / ingliz / yapon" },
        { value: "3", label: "Kuchli modul" },
      ],
    },
    features: {
      title: "3 ta kuchli modul",
      subtitle: "Veb-dashboard + Telegram bot — barcha ehtiyojlar uchun bitta tizim",
      maslahatchi: {
        title: "AI Maslahatchi",
        desc: "O'zbekistonning 2026-yilgi qonunchiligi asosida darhol maslahat — buxgalter yoki advokat kabi, lekin 24/7 va bepul.",
        bullets: [
      ...
      hujjatchi: {
        ...
        bullets: [
          ...
          "Arizalar va ishonchnomalar",
          "PDF/DOCX formatida yuklab olish",
        ],
      },
      sotuvchi: {
        title: "AI Sotuvchi",
        desc: "Telegram orqali savdo — mahsulot katalogi, buyurtmalarni qabul qilish, mijozlar bazasi. Barchasi avtomatik.",
        bullets: [
    ...
    whyUs: {
      ...
      subtitle:
        "ChatGPT ham, davlat portali ham, 1C ham emas — O'zbekiston biznes amaliyoti uchun maxsus qurilgan yagona AI tizimi",
      items: [
        {
          icon: "🇺🇿",
          title: "O'zbekiston qonunchiligi — 2026",
        ...
        {
          icon: "💰",
          title: "Professional xizmatlar narxining 10 foizi",
          desc: "Bir soatlik maslahat $50–200 turadi. Bizning yillik obunamiz o'n baravar arzon — cheksiz savollar bilan.",
        },
        {
          icon: "🌐",
          title: "4 tilda — xalqaro kompaniyalar uchun",
          desc: "O'zbek, rus, ingliz va yapon tillari. O'zbekistondagi xalqaro kompaniyalar shu tillarning istalgan birida ishlashi mumkin.",
        },
        {
          icon: "📱",
          title: "Telegram — alohida ilova shart emas",
          desc: "Xodimlar allaqachon Telegramdan foydalanadi. Yangi ilovani o'rgatish yoki o'rnatish shart emas.",
        },
        {
          icon: "🔄",
          title: "Veb + bot — bitta ekotizim",
          desc: "Dashboardda chuqur tahlil, Telegramda tezkor savollar — ikki kanalda bitta ma'lumotlar bazasi.",
        },
      ],
    },
    problems: {
      ...
      items: [
        {
          ...
          before: "Buxgalterni 1–2 kun kutish va har bir savol uchun $20–50 to'lash",
          after: "Telegram yoki veb-saytda so'rash — 5 soniyada aniq va bepul javob",
        },
        {
          emoji: "📄",
          problem: "Shartnoma tuzish",
          before: "Yuristga borish, 3–5 kun kutish va $100–300 to'lash",
          after: "AI shartnomani shablon asosida bir zumda tayyorlaydi — PDF faylni yuklab oling",
        },
        {
          emoji: "🛒",
          problem: "Telegram savdo",
          before: "Har bir buyurtmaga qo'lda javob berish, katalogni Excelda yuritish — soatlab ish",
          after: "AI bot 24/7 buyurtma qabul qiladi va katalogni avtomatik yangilaydi",
        },
        {
          emoji: "🌍",
          problem: "Xalqaro xodimlar",
          before: "Qoidalarni har bir xodim tushunadigan tilda izohlash qiyin",
          after: "Tizim 4 tilda ishlaydi — har kim o'z tilida javob oladi",
        },
      ],
    },
    automation: {
      title: "Nimalar avtomatlashadi?",
      subtitle: "Qo'lda bajariladigan ishlarni AI'ga topshiring — vaqtingizni asosiy biznesga sarflang",
      items: [
        { icon: "🧮", title: "Soliq hisoblash", desc: "Har oygi soliq summasini avtomatik hisoblash va to'lov muddatini eslatish" },
        { icon: "📝", title: "Shartnoma yaratish", desc: "Ma'lumotlarni kiriting — tayyor shartnoma bir zumda yaratiladi" },
        { icon: "👥", title: "Xodimni ishga qabul qilish", desc: "Ariza, shartnoma va buyruqdan iborat to'liq paketni avtomatik tayyorlash" },
        { icon: "🛒", title: "Telegram buyurtmalari", desc: "Buyurtmani qabul qilish, tasdiqlash va xabar berish — barchasi bot orqali" },
        { icon: "📅", title: "Muddatlar nazorati", desc: "Hisobot, to'lov va litsenziya muddatlari haqida oldindan eslatish" },
        { icon: "📊", title: "Biznes hisobotlari", desc: "Oylik savdo, xarajat va foyda bo'yicha avtomatik hisobot" },
        { icon: "💬", title: "Mijoz xizmati", desc: "Tez-tez so'raladigan savollar — bot 24/7 javob beradi" },
        { icon: "🔍", title: "Qonunchilikdagi yangilanishlar", desc: "O'zbekiston qonunchiligidagi o'zgarishlar haqida darhol xabar berish" },
      ],
    },
    forWho: {
      title: "Kim uchun?",
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Shartnoma, hisob-faktura va soliq ishlarini tez hamda to'g'ri bajaring",
        },
        {
          icon: "🌏",
          title: "O'zbekistondagi xalqaro kompaniyalar",
          desc: "Mahalliy qonunchilikni o'zbek, rus, ingliz yoki yapon tilida tushuning",
        },
        {
          icon: "🛍️",
          title: "Telegram orqali savdo qiluvchilar",
          desc: "Onlayn do'kon, ovqat yetkazib berish va xizmat ko'rsatish — Telegram botni AI'ga topshiring",
        },
      ],
    },
    howItWorks: {
      ...
      step1: { title: "Botga yozing yoki veb-dashboardga kiring", desc: "Savolingizni Telegram botga yoki veb-dashboard orqali yuboring" },
    ...
    companyOnboarding: {
      ...
      subtitle: "Biznesingizni bir joyda boshqaring — xodimlar, vazifalar, moliya, hujjatlar va AI maslahati.",
      steps: [
        {
          icon: "📋",
          step: "1-qadam",
        ...
        },
        {
          ...
          desc: "Havola orqali kompaniya ma'lumotlarini kiriting hamda login va parolni o'rnating. Tasdiqlanishni kuting.",
        },
        {
          icon: "✅",
          step: "4-qadam",
      ...
      features: [
        ...
        { icon: "📄", text: "Hujjat yaratish — shartnoma, buyruq, ariza (PDF/DOCX)" },
      ...
      cta: "Murojaat qilish",
      ctaNote: "Bepul maslahat · 24 soat ichida javob · Majburiyat yo'q",
    ...
    contact: {
      ...
      companyName: "Kompaniya nomi", companyNamePlaceholder: "Masalan: Jahongir Trade MChJ",
      ...
      sources: { ads: "Reklama", referral: "Do'st tavsiyasi", search: "Internet qidiruvi", telegram: "Telegram", other: "Boshqa" },
    ...
    pricing: {
      title: "Narxlar",
      subtitle: "Beta davrida bepul. Pro tarifi tez kunda taqdim etiladi.",
      free: {
        name: "Bepul",
        price: "$0",
        period: "/ oy",
      ...
      pro: {
        ...
        features: [
          ...
          "PDF/DOCX formatida hujjat yaratish",
    ...
    faq: {
      ...
      items: [
        {
          q: "AI Maslahatchi noto'g'ri javob bersa-chi?",
          a: "Har bir javobda ishonch darajasi ko'rsatiladi va 'Bu AI maslahati, mutaxassis bilan maslahatlashing' eslatmasi qo'yiladi. Muhim qarorlar uchun professional maslahat olishni tavsiya qilamiz.",
        },
        {
        ...
        {
          q: "Tizim qaysi tillarda javob beradi?",
          a: "AI O'zbekistonning 2026-yilgi soliq qonunchiligi, Mehnat kodeksi va biznes qoidalari asosida javob beradi. Javoblar o'zbek, rus, ingliz va yapon tillarida taqdim etiladi.",
        },
        {
          q: "Telegram bot bilan veb-dashboard o'rtasidagi farq nima?",
          a: "Telegram bot — tezkor savol-javob uchun (maslahat, hujjat so'rash). Veb-dashboard — keng funksionallik: xodimlar boshqaruvi, vazifalar, hisobotlar va AI sozlamalari.",
        },
        {
          q: "To'lov tizimi qachon ishga tushadi?",
          a: "Pro tarifi uchun Click va Payme orqali to'lovlar 2026-yilning uchinchi choragida ishga tushadi. Hozir beta davri — barcha funksiyalar bepul.",
        },
      ],
    },
    footer: {
      tagline: "O'zbekistondagi mahalliy va xalqaro biznes uchun AI yordamchisi",
  ...
  ru: {
    ...
    stats: {
      items: [
        ...
        { value: "4", label: "Языки: узбекский / русский / английский / японский" },
        { value: "3", label: "Мощных модуля" },
      ],
    },
    features: {
      title: "3 мощных модуля",
      subtitle: "Веб-дашборд + Telegram-бот — одна система для всех задач",
      maslahatchi: {
    ...
    whyUs: {
      title: "Почему выбирают нас на глобальном рынке?",
      subtitle:
        "Не ChatGPT, не государственный портал и не 1С — единственная AI-система, созданная специально для бизнес-практики Узбекистана",
      items: [
        {
          icon: "🇺🇿",
        ...
        {
          icon: "💰",
          title: "10% стоимости профессиональных услуг",
          desc: "Часовая консультация стоит $50–200. Наша годовая подписка в 10 раз дешевле — с неограниченными вопросами.",
        },
        {
          icon: "🌐",
        ...
        },
        {
          ...
          desc: "Сотрудники уже используют Telegram. Не нужно обучать сотрудников или устанавливать новые приложения.",
        },
        {
          icon: "🔄",
          title: "Веб + бот — единая экосистема",
      ...
      items: [
        {
          ...
          before: "Ждать ответа бухгалтера 1–2 дня и платить $20–50 за каждый вопрос",
          after: "Спросить в Telegram или на сайте — точный ответ за 5 секунд, бесплатно",
        },
        {
          emoji: "📄",
          problem: "Составление договора",
          before: "Обратиться к юристу, ждать 3–5 дней и платить $100–300",
          after: "AI мгновенно создаёт договор по шаблону — остаётся скачать PDF",
        },
        {
          emoji: "🛒",
        ...
        },
        {
          ...
          before: "Сложно объяснять правила на языке, понятном каждому сотруднику",
          after: "Система работает на 4 языках — каждый получает ответ на своём языке",
        },
      ],
    },
    automation: {
      ...
      items: [
        ...
        { icon: "📝", title: "Генерация договоров", desc: "Введите данные — готовый договор будет создан за несколько секунд" },
        { icon: "👥", title: "Оформление сотрудника", desc: "Заявление, договор и приказ — полный пакет документов формируется автоматически" },
        { icon: "🛒", title: "Заказы в Telegram", desc: "Приём, подтверждение, уведомление — всё через бота" },
        { icon: "📅", title: "Контроль сроков", desc: "Отчёты, платежи и лицензии — заблаговременные напоминания" },
        { icon: "📊", title: "Бизнес-отчёты", desc: "Автоматическое формирование отчётов об ежемесячных продажах, расходах и прибыли" },
    ...
    forWho: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Изучайте местное законодательство на узбекском, русском, английском или японском языке",
        },
        {
          icon: "🛍️",
          title: "Продавцы в Telegram",
    ...
    companyOnboarding: {
      ...
      steps: [
        ...
        },
        {
          ...
          desc: "По ссылке введите данные компании и создайте логин и пароль. Ожидайте подтверждения.",
        },
        {
          icon: "✅",
          step: "Шаг 4",
    ...
    contact: {
      ...
      companyName: "Название компании", companyNamePlaceholder: "Например: Jahongir Trade ООО",
      stir: "ИНН (необязательно)", stirPlaceholder: "123456789",
      ...
      employeeCount: "Количество сотрудников (примерно)", employeeCountPlaceholder: "Выберите",
    ...
    pricing: {
      title: "Тарифы",
      subtitle: "Бесплатно в период бета. Pro-тариф появится скоро.",
      free: {
        name: "Бесплатно",
        price: "$0",
        period: "/ мес",
        ...
        features: [
          ...
          "4 языка: узбекский / русский / английский / японский",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "На бесплатном тарифе доступно 5 вопросов в день. Задавать их можно через Telegram-бота в любое время. Неиспользованный лимит не переносится на следующий день.",
        },
        {
        ...
        },
        {
          ...
          a: "Telegram-бот предназначен для быстрых вопросов, консультаций и запросов документов. Веб-дашборд предоставляет расширенные возможности: управление сотрудниками, задачи, отчёты и настройки AI.",
        },
        {
    ...
    footer: {
      tagline: "AI-помощник для местного и международного бизнеса в Узбекистане",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Tax, labour law, contracts, and Telegram sales — accurate answers 24/7, in 5 seconds. At 10% of the cost of a professional consultation.",
    ...
    stats: {
      items: [
        ...
        { value: "4", label: "Languages: Uzbek / Russian / English / Japanese" },
        { value: "3", label: "Powerful modules" },
      ],
    },
    features: {
      title: "3 Powerful Modules",
      subtitle: "Web dashboard + Telegram bot — one system for every need",
      maslahatchi: {
        title: "AI Advisor",
    ...
    whyUs: {
      ...
      items: [
        {
          icon: "🇺🇿",
          title: "Uzbekistan's laws — 2026",
          desc: "Tax Code, Labor Code, licensing rules — with all recent changes.",
        },
        {
          icon: "⚡",
          title: "Answer in 5 seconds",
          desc: "Instead of waiting 2–3 days for an accountant or lawyer — get an instant answer at any time.",
        },
        {
          icon: "💰",
          title: "10% of the cost of professional services",
          desc: "A one-hour consultation costs $50–200. Our annual subscription is ten times cheaper — with unlimited questions.",
        },
        {
          icon: "🌐",
        ...
        },
        {
          ...
          desc: "Employees already use Telegram. No need to train staff or install a new application.",
        },
        {
          icon: "🔄",
      ...
      items: [
        {
          ...
          before: "Wait 1–2 days for an accountant and pay $20–50 per question",
          after: "Ask in Telegram or on the web — accurate answer in 5 seconds, free",
        },
        {
          emoji: "📄",
          problem: "Drafting a contract",
          before: "Go to a lawyer, wait 3–5 days, and pay $100–300",
          after: "AI creates the contract from a template instantly — download the PDF",
        },
        {
          emoji: "🛒",
        ...
        },
        {
          ...
          before: "Explaining rules in a language every employee understands is difficult",
          after: "The system works in 4 languages — everyone gets answers in their preferred language",
        },
      ],
    },
    automation: {
      ...
      items: [
        ...
        { icon: "📝", title: "Contract generation", desc: "Enter the details — a complete contract is ready in seconds" },
        { icon: "👥", title: "Employee onboarding", desc: "Application, contract, and employment order — the full package is generated automatically" },
        { icon: "🛒", title: "Telegram orders", desc: "Order acceptance, confirmation, and notifications — all handled by the bot" },
    ...
    forWho: {
      ...
      items: [
        {
          icon: "🧑‍💼",
          title: "Sole traders (YaTT)",
          desc: "Handle tax, reporting, and HR matters yourself without an accountant",
        },
        {
          icon: "🏢",
        ...
        },
        {
          ...
          desc: "Understand local laws in Uzbek, Russian, English, or Japanese",
        },
        {
          icon: "🛍️",
          title: "Telegram sellers",
          desc: "Online shops, food delivery businesses, and service providers — automate sales with an AI-powered Telegram bot",
        },
      ],
    },
    howItWorks: {
      ...
      step1: { title: "Message the bot or open the web dashboard", desc: "Send your question through the Telegram bot or the web dashboard" },
      step2: { title: "AI analyses your request", desc: "Uzbekistan law knowledge base + Claude AI — an accurate, reliable answer" },
      step3: { title: "Get your answer instantly", desc: "Receive practical advice in 5 seconds and generate a document when needed" },
    },
    companyOnboarding: {
      badge: "For Companies",
      title: "Connect Your Company",
      subtitle: "Manage your business in one place — employees, tasks, finances, documents, and AI advice.",
      steps: [
        {
          icon: "📋",
          step: "Step 1",
        ...
        },
        {
          ...
          desc: "We will show you the system and answer your questions. Once we agree, we will send you a personal invite link.",
        },
        {
          icon: "🏢",
          step: "Step 3",
      ...
      features: [
        { icon: "👥", text: "Employee management — HR, roles, positions, and employee details" },
    ...
    contact: {
      ...
      sources: { ads: "Advertisement", referral: "Referral from a friend", search: "Internet search", telegram: "Telegram", other: "Other" },
    ...
    pricing: {
      ...
      free: {
        ...
        features: [
          ...
          "4 languages: Uzbek / Russian / English / Japanese",
          "Telegram bot + Web dashboard",
      ...
      pro: {
        ...
        badge: "Coming soon",
        features: [
          "50 requests / day (unlimited plans available)",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "The free plan includes 5 questions per day. You can ask them through the Telegram bot at any time. The limit resets daily and does not roll over.",
        },
        {
          q: "Is my data secure?",
        ...
        },
        {
          ...
          a: "The Telegram bot is for quick questions, advice, and document requests. The web dashboard provides full functionality: employee management, tasks, reports, and AI settings.",
        },
        {
  ...
  ja: {
    ...
    stats: {
      items: [
        ...
        { value: "4", label: "言語：ウズベク語 / ロシア語 / 英語 / 日本語" },
        { value: "3", label: "強力なモジュール" },
      ],
    },
    features: {
      title: "3つの強力なモジュール",
      subtitle: "Webダッシュボード + Telegramボット — 1つのシステムですべてのニーズに対応",
      maslahatchi: {
        title: "AIアドバイザー",
        desc: "2026年のウズベキスタン法に基づく即時アドバイス — 会計士や弁護士のように、24時間365日無料で利用できます。",
        bullets: [
          "個人事業主・LLC の税率と期限",
          "雇用契約と解雇手続き",
          "ライセンスと許認可",
      ...
      hujjatchi: {
        title: "AI書類作成",
        desc: "契約書・申請書・命令書をテンプレートから即座に作成。弁護士を待つ必要も、書類を一から作る必要もありません。",
        bullets: [
          "雇用契約書（標準・個別）",
          "サービス契約書",
          "解雇・任命命令書",
    ...
    whyUs: {
      title: "グローバル市場で選ばれる理由",
      subtitle:
        "ChatGPTでも政府ポータルでも1Cでもない — ウズベキスタンのビジネス実務専用に構築された唯一のAIシステム",
      items: [
        {
          icon: "🇺🇿",
          title: "ウズベキスタン法 — 2026年版",
          desc: "税法・労働法・ライセンス規則 — 最新の変更点を含む。",
        },
        {
          icon: "⚡",
          title: "5秒で回答",
          desc: "会計士や弁護士を2〜3日待つ代わりに、いつでも即座に回答を得られます。",
        },
        {
          icon: "💰",
          title: "専門サービス費用の10分の1",
          desc: "1時間の相談料は$50〜200。年間サブスクリプションなら10分の1の費用で、質問は無制限です。",
        },
        {
          icon: "🌐",
          title: "4言語 — 外資企業向け",
          desc: "ウズベク語・ロシア語・英語・日本語。ウズベキスタンの外資企業は、この4言語から希望する言語を選べます。",
        },
        {
          icon: "📱",
          title: "Telegram — 別アプリ不要",
          desc: "従業員はすでにTelegramを利用しています。新しいアプリのインストールや研修は不要です。",
        },
        {
          icon: "🔄",
          title: "Web + ボット — 統合エコシステム",
          desc: "ダッシュボードで詳細分析、Telegramで素早い質問 — 2チャンネル、1つのナレッジベース。",
        },
      ],
    },
    problems: {
      title: "どのような問題を解決できますか？",
      ...
      items: [
        ...
        },
        {
          emoji: "📄",
          problem: "契約書の作成",
          before: "弁護士に依頼し、3〜5日待って$100〜300支払う",
          after: "AIがテンプレートから契約書を即座に作成 — PDFでダウンロード",
        },
        {
          emoji: "🛒",
          problem: "Telegram販売",
          before: "各注文に手動で返信し、Excelでカタログを管理 — 何時間もの作業",
          after: "AIボットが24/7注文受付、カタログ自動更新",
        },
        {
          emoji: "🌍",
          problem: "外国人従業員",
          before: "各従業員が理解できる言語で規則を説明するのは難しい",
          after: "4言語に対応 — 誰もが希望する言語で回答を得られる",
        },
      ],
    },
    automation: {
      ...
      items: [
        { icon: "🧮", title: "税額計算", desc: "毎月の税額を自動計算し、支払期限を通知" },
        { icon: "📝", title: "契約書生成", desc: "情報を入力するだけで、数秒後に契約書が完成" },
        { icon: "👥", title: "従業員の入社手続き", desc: "申請書・契約書・命令書の一式を自動作成" },
        ...
        { icon: "🔍", title: "法改正情報", desc: "ウズベキスタンの法改正を即時通知" },
      ],
    },
    forWho: {
      title: "どなた向けですか？",
      ...
      items: [
        ...
        },
        {
          icon: "🌏",
          title: "ウズベキスタンの外資企業",
          desc: "現地法をウズベク語・ロシア語・英語・日本語のいずれかで理解できます",
        },
        {
          icon: "🛍️",
          title: "Telegram販売者",
    ...
    howItWorks: {
      title: "使い方",
      subtitle: "3つの簡単なステップ",
      step1: { title: "ボットまたはWebダッシュボードを開く", desc: "TelegramボットまたはWebダッシュボードから質問を送信" },
      step2: { title: "AIが質問を分析", desc: "ウズベキスタン法のナレッジベース + Claude AI — 正確で信頼性の高い回答" },
      step3: { title: "即座に回答を受け取る", desc: "5秒で実用的なアドバイスを受け取り、必要に応じて書類を作成" },
    },
    companyOnboarding: {
      badge: "企業向け",
      title: "貴社をシステムに登録する",
      subtitle: "ビジネスを一か所で管理 — 従業員・タスク・財務・書類・AI相談。",
      steps: [
        {
          icon: "📋",
          step: "ステップ1",
      ...
      featuresTitle: "企業ダッシュボードで何ができますか？",
      features: [
    ...
    contact: {
      ...
      businessTypes: { yatt: "個人事業主", llc: "有限責任会社（LLC）", jsc: "株式会社（JSC）", other: "その他" },
    ...
    register: {
      ...
      legalForms: { yatt: "個人事業主", llc: "有限責任会社", jsc: "株式会社", other: "その他" },
      stir: "税務番号",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Telegramボットは、簡単な質問・相談・書類リクエスト向けです。Webダッシュボードでは、従業員管理・タスク・レポート・AI設定など、すべての機能を利用できます。",
        },
        {
          q: "決済機能はいつ開始しますか？",
    ...
    footer: {
      ...
      rights: "© 2026 AI Business Concierge. すべての権利を保有します。",
